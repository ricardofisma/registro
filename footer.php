	...
	<body>
		...
		<footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<h3>MagTimus<span>Fisma</span></h3>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p><span>Jr Untiveros</span> Ayacucho, Perú</p>
				</div>
			...
			<div class="footer-right">
				...
				<p class="footer-company-about">
					...
					Ciencias Físico matemáticas y programador web didáctico, gráfico deseñador, web developers &amp; SEO Learner.
				</p>
